...
const HOTELS: Hotel[] = [
  ...
  },
  {
    ...
    rates: [
      { currentIcon: "lock", currentValue: "$215.00", recommendedIcon: "equals", recommendedValue: "$215.00", committedOccupancy: 47, demandOccupancy: "62%", competitorAverage: "$220.00" },
  ...
  },
  {
    ...
    rates: [
      ...
      { currentIcon: "lock", currentValue: "€520.00", recommendedIcon: "equals", recommendedValue: "€520.00", committedOccupancy: 57, demandOccupancy: "75%", competitorAverage: "€510.00" },
    ...
    <div className="overflow-x-auto">
      <table className="border-collapse text-[13px]" style={{ minWidth: "900px" }}>
        <thead>
          ...
          <tr>
            <th
              className="text-left px-4 py-2 font-semibold border-b border-r sticky left-0 z-20"
              style={{
                width: "180px",
                borderColor: BORDER,
                color: PRIMARY_TEXT,
              ...
              return (
                <Fragment key={day}>
                  <th
                    ...
                    style={{ backgroundColor: SUBHEADER_BG, borderColor: BORDER, color: SUBHEADER_TEXT, width: "90px" }}
                  >
                    Current
                  </th>
                  <th
                  ...
                  {expanded && (
                    <>
                      <th
                        className="text-right px-4 py-1 font-normal border-b border-r text-[12px]"
                        style={{ backgroundColor: SUBHEADER_BG, borderColor: BORDER, color: SUBHEADER_TEXT, width: "100px" }}
                      >
                        Committed Occupancy
                      </th>
                      <th
