...
function ArrowUp() {
  return <span style={{ color: "#006461", fontSize: "12px", marginLeft: "2px" }}>▲</span>;
}
function ArrowDown() {
  return <span style={{ color: "#d32f2f", fontSize: "12px", marginLeft: "2px" }}>▼</span>;
}
...
export default function V3SinglePage() {
  return (
    <Suspense>
      <V3SingleContent />
    </Suspense>
